  ...
  return (
    <div className="flex flex-col items-center">
      <div
        ...
        active:bg-gray-700/30 transition-colors p-3 bg-gray-800/40 backdrop-blur-sm"
        onClick={onClick}
      >
...
export function ButtonOverlay({
  ...
  return (
    <div className="absolute right-2 bottom-2 flex flex-col gap-4 items-center pb-10 rounded-lg p-2 z-10">
      <Button
      ...
      <Button Icon={Clock1} text={getTimeAgo(new Date(createdAt))} />
    </div>
  );
}
